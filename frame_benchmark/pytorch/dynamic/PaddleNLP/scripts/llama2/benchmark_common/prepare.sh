...
shakechen/Llama-2-7b-hf)
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/LICENSE.txt
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/README.md
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/Responsible-Use-Guide.pdf
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/USE_POLICY.md
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/config.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/configuration.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/generation_config.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/model-00001-of-00002.safetensors
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/model-00002-of-00002.safetensors
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/model.safetensors.index.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/pytorch_model-00001-of-00002.bin
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/pytorch_model-00002-of-00002.bin
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/pytorch_model.bin.index.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/special_tokens_map.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/tokenizer.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/tokenizer.model
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/shakechen/Llama-2-7b-hf/tokenizer_config.json
    echo "download models for shakechen/Llama-2-7b-hf done" ;;
ydyajyA/Llama-2-13b-chat-hf)
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/config.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/configuration.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/generation_config.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/model-00001-of-00006.safetensors
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/model-00002-of-00006.safetensors
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/model-00003-of-00006.safetensors
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/model-00004-of-00006.safetensors
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/model-00005-of-00006.safetensors
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/model-00006-of-00006.safetensors
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/model.safetensors.index.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/pytorch_model.bin.index.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/special_tokens_map.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/tokenizer.json
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/tokenizer.model
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/ydyajyA/Llama-2-13b-chat-hf/tokenizer_config.json
...
meta-llama/Llama-2-70b-hf)
    ...
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/meta-llama/Llama-2-70b-hf/USE_POLICY.md
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/meta-llama/Llama-2-70b-hf/config.json
    ...
    wget --no-proxy https://paddlenlp.bj.bcebos.com/models/huggingface/meta-llama/Llama-2-70b-hf/tokenizer_config.json
