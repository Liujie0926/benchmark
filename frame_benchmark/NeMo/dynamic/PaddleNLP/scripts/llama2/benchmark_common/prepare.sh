...
wget https://paddlenlp.bj.bcebos.com/llm_benchmark_data/NeMo_models_meta-llama.tar.gz
tar zxf NeMo_models_meta-llama.tar.gz && rm -rf NeMo_models_meta-llama.tar.gz
cd -
...
model_name_or_path=${model_name_or_path:-"Llama-2-7b-hf"}
